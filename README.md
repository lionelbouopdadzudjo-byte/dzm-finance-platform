...
## Seed in-memory backend
- Au démarrage backend, les données sont automatiquement chargées en mémoire (`AUTO_SEED_IN_MEMORY=true` par défaut).
- `npm run seed` recharge explicitement ces données de démo.
